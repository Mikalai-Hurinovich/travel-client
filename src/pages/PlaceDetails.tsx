				...
				{place?.photos?.length > 0 && place?.photos.map((photo) =>
					<div className="flex justify-center" key={photo.id}>
						<img
							...
							src={`${process.env.REACT_APP_BASE_API}/${photo.path}`} alt="placePhoto"/>
					</div>
				)}
			</div>
		</div>
			...
			<div className="mt-8 w-2/3">
              ...
              <div className="w-2/3">
                  <img onClick={() => setModalShow(true)}
                       ...
                       src={`${process.env.REACT_APP_BASE_API}/${place.photos[0].path}`} alt="placePhoto"/>
              </div>}
              ...
              <div className="flex flex-col gap-2 w-1/3">
                  <img onClick={() => setModalShow(true)} key={place.photos[1].id}
                       ...
                       src={`${process.env.REACT_APP_BASE_API}/${place.photos[1].path}`}
                       alt="placePhoto"/>
                  <img onClick={() => setModalShow(true)} key={place.photos[2].id}
                       ...
                       src={`${process.env.REACT_APP_BASE_API}/${place.photos[2].path}`}
                       alt="placePhoto"/>
              </div>
					}
